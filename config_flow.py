...
from ..yandex_station.core.yandex_session import LoginResponse, YandexSession

_LOGGER = logging.getLogger(__name__)


# noinspection PyUnusedLocal
class YandexGoFlowHandler(ConfigFlow, domain=DOMAIN):
    @property
    @lru_cache
    def yandex(self):
        session = ac.async_create_clientsession(self.hass)
    ...
    async def async_step_qr(self, user_input):
        ...
        if not resp:
            self.cur_step["errors"] = {"base": "unauthorized"}
